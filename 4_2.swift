...
let mostSleepingGuard = guards.mapValues { $0.max()! }.max { a, b in a.value < b.value }!
let mostSleepingMinute = guards[mostSleepingGuard.key]!.indices.filter { guards[mostSleepingGuard.key]![$0] == mostSleepingGuard.value }
print(mostSleepingGuard)
print(mostSleepingMinute)
print(mostSleepingMinute[0] * Int(mostSleepingGuard.key)!)
